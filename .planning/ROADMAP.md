...
**Plans:** 2 plans
Plans:
- [ ] 08-01-PLAN.md — Route, nav tab, supplement list with cards, search/filter, supplement form with all metadata fields
...
| 8. Supplement Manager + Inventory | v2.0 | 0/2 | Not started | - |
